    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-20 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            <div className="p-8">
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 text-center">Terms & Conditions</h1>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  <a href="https://shwetanshwelfaretrust.vercel.app/" className="text-brand-600 hover:underline">
                    https://shwetanshwelfaretrust.vercel.app/#departments
                  </a> ('Website'), including the related 
                  mobile site and mobile application (hereinafter referred to as 'Platform').
                </p>
                <p className="text-gray-700 mb-4">
                  The Platform is owned by <strong>Shwetansh Welfare and Educational Trust</strong>, a company incorporated 
                  under the Companies Act, 1956 with its registered office at DEEPSHIKA BHAWAN, CIVIL 
                  LINES, Shahdol, India (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').
                </p>
              ...
              <section className="mb-8">
                ...
                <ol className="list-decimal pl-6 text-gray-700 space-y-2">
                  ...
                  <li>
                    ...
                    jurisdiction of the courts in Shahdol and Madhya Pradesh.
                  </li>
                  <li>
